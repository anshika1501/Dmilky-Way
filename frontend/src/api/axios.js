...
const API_BASE_URL = import.meta.env.VITE_API_BASE_URL || "http://135.235.139.169:8001";

// Debug: show resolved API base URL in browser console
console.log("VITE_API_BASE_URL =>", import.meta.env.VITE_API_BASE_URL, "| resolved =>", API_BASE_URL);
